              ...
              >
                Sign up with Google
                        ...
                        <div className="form-row mt-4 mx-5 text-black">
                            <h6 className='d-inline-block text-black'>Already have account? <span className='d-inline-block mx-4  text-decoration-none ' ><Link to={'/buyerlogin'} className='text-black' >LogIn</Link> </span></h6>
                        </div>
