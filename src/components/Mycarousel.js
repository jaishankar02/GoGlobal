...
const Mycarousel = () => {
  ...
  >
    <div className="row mx-3 my-auto   card rounded-5">
      ...
      >
        <div className="carousel-inner mx-md-2 mb-5 w-100" role="listbox">
                ...
                <div className=" py-5 row py-md-4 mt-3">
                  <div className="col-lg-5 col-sm-10">
                    ...
                    <button
                      ...
                      className="btn  my-faq-text  shadow my-button text-white rounded-5 py-3 px-4 my-5 btn-lg "
                    >
                      Add to Cart
                    </button>
                    <button
                      style={{ backgroundColor: "white", fontWeight: "bold" }}
                      className="btn  my-faq-text  shadow my-button text-black rounded-5 mx-5 py-3 px-4 my-5 btn-lg "
                    >
                      Shop Now
                    </button>
                  ...
                  <div className="col-lg-7 text-center col-sm-10 mt-3">
                    <div className="d-flex   justify-content-center d-inline-block mb-4">
                        ...
                        <img className='my-carousel-img  justify-content-center' src={require("../assets/image/Rectangle_1-removebg-preview.png")}/>
