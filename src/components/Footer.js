          ...
          <div className="row my-trans-part gx-lg-5 mt-5">
            <div className="col-lg-3 my-trans-part col-md-6 mb-4  mb-md-0">
              <ul className="list-unstyled my-trans-part mb-2">
                ...
                <div className="container my-trans-part mx-0 mt-3 mb-5">
                  <div className="row my-trans-part">
                    <div className="col-12 my-trans-part ">
                      <div className=" rounded-2  my-trans-part"><img className='rounded-4 my-trans-part my-qr-img' src={require('../assets/image/main-qr.png')} /></div>
                    </div>
                  </div>
                </div>
